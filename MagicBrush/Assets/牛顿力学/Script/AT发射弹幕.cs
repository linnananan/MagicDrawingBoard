...
public class AT发射弹幕 : MonoBehaviour {
    ...
    void Start () {
        ...
        Vector3 pos = transform.position + new Vector3(Random.Range(-0.1f,0.7f), Random.Range(-0.1f, 0.7f), 0);
    ...
    Vector3 attract()
    {
        ...
        if (distance > -0.1f && distance <0.7f)
        {
